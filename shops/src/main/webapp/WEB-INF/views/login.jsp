			...
			<div id="contents">
				<div id="member">
					...
					<div class="informbox">
						<div class="inform">
							<ul>
								<li><input type="text" id="id" class="loginType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='loginType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
								<li><input type="password" id="pw" class="passType" onfocus="this.className='mfocus'" onblur="if (this.value.length==0) {this.className='passType'}else {this.className='mfocusnot'}" style="ime-mode:inactive;" /></li>
							</ul>

							<div class="btn"><a onclick="login()" class="sbtn">로그인</a></div>
					...
					<div class="informbox">
						<div class="inform">
							...
							<div class="point">
								<p>아직 KIWON 회원이 아니신가요? <span>회원가입하시고 다양한 혜택을 받으세요.</span></p>
